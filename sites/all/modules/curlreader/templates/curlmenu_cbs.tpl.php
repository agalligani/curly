<?php $keyName = 'Columbia Business'; ?>
<?php $ifid = variable_get('columbia_business_image'); ?>
...
<?php $logoid = variable_get('columbia_business_logo'); ?>
...
<h4>About</h4>
<a href="/alumni/news/magazine">About Columbia Business</a>
<a href="/alumni/news/magazine/contact">Contact</a>
<a href="/alumni/news/hermes/print-archive">Print Archive</a>
</nav> 
<nav class="nav-sprite clearfix">
<h4>Engage</h4>
<a href="/articles/columbia-business/rss/" class="nav-sprite-rss" target="_blank"><span class='icon-18'></span>RSS</a>
